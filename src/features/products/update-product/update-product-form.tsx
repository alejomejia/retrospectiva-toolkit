...
import { useUpdateProductForm } from './hooks/use-update-product-form'
...
export function UpdateProductForm({ data, onSubmit, onCancel }: UpdateProductFormProps) {
  const { form, onFormSubmit, onError, productType, isSubmitting } = useUpdateProductForm({
    data,
    onSubmit
  })
